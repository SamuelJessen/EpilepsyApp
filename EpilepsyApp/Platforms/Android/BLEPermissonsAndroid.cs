...
namespace EpilepsyApp.Platforms.Android
{
   public class BluetoothPermissions : Permissions.BasePlatformPermission
   {
      ...
      public BluetoothPermissions() : this(true, false, true, false)
      {
      }
      ...
      /// </remarks>
      public BluetoothPermissions(bool scan = true, bool advertise = true, bool connect = true,
         bool bluetoothLocation = true)
      {
         _scan = scan;
